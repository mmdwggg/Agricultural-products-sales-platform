<template>
  <div class="goods-box2">
    ...
    <el-carousel-item >
      <img src="../assets/lib3.jpg" style="width: 100%;">
    </el-carousel-item>
    <el-carousel-item >
      <img src="../assets/lib2.webp" style="width: 100%;">
    </el-carousel-item>
    <el-carousel-item >
      <img src="../assets/lib3.webp" style="width: 100%;">
    </el-carousel-item>
  </el-carousel>
    </div>
    ...
    <div class="search">
      ...
      <div>
        <p style="color: black;font-size:20px;"><b>猜你喜欢：</b></p>
      </div>
    </div>
    <div class="goods" v-for="(item, index) in cgoods" :key="index"
      ...
      <div class="info">
        <p class="content">
          <i  style="color:#00c71b;font-size:12px;font-style:normal;" v-if="item.type == 'goods'">[供]</i>
          <i style="color:#dc0101;font-size:12px;font-style:normal;" v-else>[需]</i>
